...
STYLESHEET = (
    ...
    "}"
    "QTabWidget::pane {"
    "border-top: 1px solid " + f"{BACKGROUND_COLOR2}" + ";"
    "}"
    "QTabWidget::tab-bar {"
    "left: 5px;"
    "}"
    "QTabBar::tab {"
    "background: " + f"{SURFACE_COLOR}" + ";"
    "border: 1px solid " + f"{BACKGROUND_COLOR2}" + ";"
    "border-bottom: none;"
    "padding: 5px;"
    "min-width: 80px;"
    "}"
    "QTabBar::tab:selected {"
    "background: " + f"{BACKGROUND_COLOR2}" + ";"
    "}"
    "QTabBar::tab:!selected {"
    "margin-top: 2px;"
    "}"
    "QTabBar::tab:hover {"
    "background: " + f"{HOVER_COLOR}" + ";"
    "}"
)
